  ...
  return (
    <InternalPageChrome breadcrumbs={[{ label: "Home", href: "/" }, { label: "About Us" }]}>
      <article className="mx-auto max-w-3xl">
        <h1 className="font-serif text-4xl font-semibold text-zinc-950 dark:text-zinc-50">About Econography</h1>
        ...
        <p className="mt-4 font-sans leading-relaxed text-zinc-700 dark:text-zinc-300">
