    ...
    <div className="grid grid-cols-12 gap-10 lg:gap-12">
      <div className="col-span-12 space-y-10 lg:col-span-8">
        <div className="space-y-5">
          <div className="skeleton-pulse aspect-[16/9] w-full rounded-lg" />
        ...
        <div className="space-y-6">
          ...
          <div className="skeleton-pulse h-40 w-full rounded-lg" />
          <div className="skeleton-pulse h-40 w-full rounded-lg" />
        </div>
      </div>
      <aside className="col-span-12 space-y-6 lg:col-span-4 lg:sticky lg:top-28 lg:self-start">
        ...
        <div className="skeleton-pulse h-36 w-full rounded-lg" />
        <div className="skeleton-pulse h-36 w-full rounded-lg" />
      </aside>
    </div>
  );
